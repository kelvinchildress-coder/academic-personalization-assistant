/**
 * Phase 5 — Student report PDF endpoint (Cycle I — JSX form).
 *
 ...
 *
 * This file uses JSX so the StudentReportPDF element is typed as a
 * ReactElement of <Document>, satisfying renderToStream's signature.
 */
...
export async function GET(req: NextRequest, ctx: RouteContext) {
  ...
  // JSX form — typed correctly because StudentReportPDF returns
  // <Document>, which is exactly what renderToStream expects.
  const nodeStream = await renderToStream(
    <StudentReportPDF payload={payload} />,
  );
